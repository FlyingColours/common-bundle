...
This version works with Symfony 4.3, for previous version of Symfony framework please check [previous](https://github.com/FlyingColours/common-bundle/blob/0.1.10/README.md) versions of this bundle.
